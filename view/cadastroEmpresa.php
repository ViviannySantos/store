...
<div class="container">
    ...
    <div class="row">
        <div class="col-sm-12">
            <form class="form-horizontal" id="iFormCadastroEmpresa" name="nformCadastroEmpresa" action="../controller/cadastrarUsuario.php" method="post">
                <input type="hidden" id="categoriausuario" name="categoriausuario" value="2"/>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <input type="text" class="form-control" id="nome" name="nNomeUsuario" placeholder="Nome da empresa">
                    </div>
                </div>
                <div class="form-group">
